...
- **Manifest:** `gemini-extension.json` defines the extension, repository, and the `GEMEER_PACK` setting.
...
## Key Configuration
- **Active Pack:** Controlled by the `GEMEER_PACK` environment variable (set via `gemini extensions config`).
